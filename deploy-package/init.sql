...
CREATE TABLE IF NOT EXISTS users (
    ...
    username VARCHAR(191) UNIQUE NOT NULL COMMENT '用户名',
    password VARCHAR(255) NOT NULL COMMENT '密码(BCrypt加密)',
    email VARCHAR(191) DEFAULT '' COMMENT '邮箱',
...
CREATE TABLE IF NOT EXISTS articles (
    ...
    title_zh VARCHAR(191) DEFAULT '' COMMENT '中文标题',
    url VARCHAR(500) UNIQUE NOT NULL COMMENT '文章链接',
    author VARCHAR(191) DEFAULT '' COMMENT '作者',
    content TEXT COMMENT '内容',
    content_zh TEXT COMMENT '中文内容',
    summary TEXT COMMENT '摘要',
    summary_zh TEXT COMMENT '中文摘要',
    source VARCHAR(100) NOT NULL COMMENT '来源',
    tags VARCHAR(191) DEFAULT '' COMMENT '标签',
...
CREATE TABLE IF NOT EXISTS daily_reports (
    ...
    title VARCHAR(191) NOT NULL COMMENT '日报标题',
